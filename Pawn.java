public class Pawn extends Piece {
    ...
    public boolean isLegalMove(int fromX, int fromY, int toX, int toY, Board board) {
        ...
        else if(!board.getPiece(toX, toY).getColor().equals(board.getPiece(fromX, fromY).getColor()) &&
                (board.getPiece(fromX, fromY).getColor().equals("white") && (toX == fromX -1 || toX == fromX + 1) && toY == fromY + 1 &&board.getPiece(toX, toY) != null) ||
                (board.getPiece(fromX, fromY).getColor().equals("black") && (toX == fromX -1 || toX == fromX + 1) && toY == fromY - 1 && board.getPiece(toX, toY) != null)) {
